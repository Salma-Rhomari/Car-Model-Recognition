      ...
      <div className="relative z-10 w-full max-w-lg">
        ...
        <div className="rounded-2xl border border-neutral-800 bg-gradient-to-b from-neutral-900/80 to-black/80 backdrop-blur-xl p-8 shadow-2xl shadow-black/50">
          ...
          <button
            ...
            className="mt-6 w-full rounded-lg bg-emerald-500 text-black font-medium py-3 text-sm tracking-wide disabled:opacity-30 disabled:cursor-not-allowed hover:bg-emerald-400 transition-colors"
          >
